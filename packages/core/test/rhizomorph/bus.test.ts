...
function setup(
  ...
  const hyphae: GerminatedHypha[] = [{
    name: 'console',
    manifest: { kind: 'hypha', name: 'console', septum: '^0.12', capabilities: ['reactions'] },
    instance: hypha,
    config: {},
  }]
  const enzymes: GerminatedEnzyme[] = [{
    name: 'ping',
    manifest: { kind: 'enzyme', name: 'ping', septum: '^0.12', commands },
    instance,
...
it('names the failed command, not just the channel, when a respond: send throws', async () => {
  ...
  const hyphae: GerminatedHypha[] = [{
    name: 'console',
    manifest: { kind: 'hypha', name: 'console', septum: '^0.12', capabilities: [] },
    instance: hypha,
    config: {},
  }]
  const enzymes: GerminatedEnzyme[] = [{
    name: 'ping',
    manifest: {
      kind: 'enzyme', name: 'ping', septum: '^0.12',
...
function harness(options: {
  ...
  const hypha = {
    name: 'console',
    config: {},
    manifest: { kind: 'hypha' as const, name: 'console', septum: '^0.12', capabilities: options.capabilities ?? [] },
    instance: {
  ...
  const enzyme = {
    ...
    scopes: [],
    manifest: { kind: 'enzyme' as const, name: 'media', septum: '^0.12', commands: options.commands },
    instance: {
      handlers: {
...
describe('the four refusal callbacks, threaded with the locale bus.ts resolved', () => {
  it("passes the reader's locale, not the default, to each of onUnrouted/onDenied/onUnsupported/onOutOfContext", async () => {
    ...
    const hypha = {
      name: 'console', config: {},
      manifest: { kind: 'hypha' as const, name: 'console', septum: '^0.12', capabilities: [] },
      instance: {
    ...
    const enzyme = {
      ...
      manifest: {
        kind: 'enzyme' as const, name: 'media', septum: '^0.12',
        commands: [
